    ...
    /* Tworzenie reprezentacji bazy danych (jej tabel i kolumn) w programie
        ...
        */
        ...
        private void DetermineDatabaseConstruction()
        {
            ...
            database_columns.Add(new Tuple<int, string, string>(1, @"NAME", @"VARCHAR(512) CHARACTER SET UTF8 NOT NULL"));
            ...
            database_columns.Add(new Tuple<int, string, string>(2, @"NAME", @"VARCHAR(512) CHARACTER SET UTF8 NOT NULL"));
            ...
            database_columns.Add(new Tuple<int, string, string>(3, @"NAME", @"VARCHAR(512) CHARACTER SET UTF8 NOT NULL"));
            ...
            database_columns.Add(new Tuple<int, string, string>(4, @"NAME", @"VARCHAR(512) CHARACTER SET UTF8 NOT NULL"));
            ...
            database_columns.Add(new Tuple<int, string, string>(5, @"NAME", @"VARCHAR(512) CHARACTER SET UTF8 NOT NULL"));
                ...
                */
                ...
                for (int i = 0; i < metadata.Count; i++)
                {
                        ...
                        if (metadata[i].Length != 0)
                        {
                            ...
                            columns_to_populate.RemoveAll(x => x.Item2.Equals("ALTERNATE_PATHS")); // wyrzucamy z automatycznego wypelniania również kolumnę ALTERNATE_PATHS
                            ...
                            {
                                if (!(metadata[i].ElementAt(j).Equals("NULL")))
                                {
                                    add_data.Parameters.AddWithValue(values_passed[j], metadata[i].ElementAt(j));
                            ...
                            {
                                for (int j = metadata[i].Count(); j < values_passed.Length; j++)
                                {
                                    add_data.Parameters.AddWithValue(values_passed[j], null);
                                    //add_data.Parameters[j - 1].Charset = FbCharset.Utf8;
                                }

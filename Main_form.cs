    ...
    /* Tworzenie reprezentacji bazy danych (jej tabel i kolumn) w programie
        ...
        */
        ...
        private void DetermineDatabaseConstruction()
        {
            ...
            database_columns.Add(new Tuple<int, string, string>(0, @"NAME", @"VARCHAR(128) CHARACTER SET UTF8 NOT NULL"));
            ...
            database_columns.Add(new Tuple<int, string, string>(1, @"NAME", @"VARCHAR(128) CHARACTER SET UTF8 NOT NULL"));
            database_columns.Add(new Tuple<int, string, string>(1, @"EXTENSION", @"VARCHAR(5) NOT NULL"));
            database_columns.Add(new Tuple<int, string, string>(1, @"PATH", @"VARCHAR(512) CHARACTER SET UTF8 NOT NULL"));
            ...
            database_columns.Add(new Tuple<int, string, string>(2, @"NAME", @"VARCHAR(128) CHARACTER SET UTF8 NOT NULL"));
            database_columns.Add(new Tuple<int, string, string>(2, @"EXTENSION", @"VARCHAR(5) NOT NULL"));
            database_columns.Add(new Tuple<int, string, string>(2, @"PATH", @"VARCHAR(512) CHARACTER SET UTF8 NOT NULL"));
            ...
            database_columns.Add(new Tuple<int, string, string>(2, @"LANGUAGE", @"VARCHAR(32) CHARACTER SET UTF8"));
            database_columns.Add(new Tuple<int, string, string>(2, @"TITLE", @"VARCHAR(256) CHARACTER SET UTF8"));
            database_columns.Add(new Tuple<int, string, string>(2, @"SUBJECT", @"VARCHAR(256) CHARACTER SET UTF8"));
            database_columns.Add(new Tuple<int, string, string>(2, @"DESCRIPTION", @"VARCHAR(512) CHARACTER SET UTF8"));
            database_columns.Add(new Tuple<int, string, string>(2, @"KEYWORDS", @"VARCHAR(128) CHARACTER SET UTF8"));
            database_columns.Add(new Tuple<int, string, string>(2, @"COMMENTS", @"VARCHAR(512) CHARACTER SET UTF8"));
            database_columns.Add(new Tuple<int, string, string>(2, @"PUBLISHER", @"VARCHAR(256) CHARACTER SET UTF8"));
            database_columns.Add(new Tuple<int, string, string>(2, @"COMPANY", @"VARCHAR(256) CHARACTER SET UTF8"));
            database_columns.Add(new Tuple<int, string, string>(2, @"AUTHOR", @"VARCHAR(64) CHARACTER SET UTF8"));
            database_columns.Add(new Tuple<int, string, string>(2, @"CREATOR", @"VARCHAR(64) CHARACTER SET UTF8"));
            database_columns.Add(new Tuple<int, string, string>(2, @"LAST_AUTHOR", @"VARCHAR(64) CHARACTER SET UTF8"));
            ...
            database_columns.Add(new Tuple<int, string, string>(3, @"NAME", @"VARCHAR(128) CHARACTER SET UTF8 NOT NULL"));
            database_columns.Add(new Tuple<int, string, string>(3, @"EXTENSION", @"VARCHAR(5) NOT NULL"));
            database_columns.Add(new Tuple<int, string, string>(3, @"PATH", @"VARCHAR(512) CHARACTER SET UTF8 NOT NULL"));
            ...
            database_columns.Add(new Tuple<int, string, string>(4, @"NAME", @"VARCHAR(128) CHARACTER SET UTF8 NOT NULL"));
            database_columns.Add(new Tuple<int, string, string>(4, @"EXTENSION", @"VARCHAR(5) NOT NULL"));
            database_columns.Add(new Tuple<int, string, string>(4, @"PATH", @"VARCHAR(512) CHARACTER SET UTF8 NOT NULL"));
            ...
            database_columns.Add(new Tuple<int, string, string>(5, @"NAME", @"VARCHAR(128) CHARACTER SET UTF8 NOT NULL"));
            database_columns.Add(new Tuple<int, string, string>(5, @"EXTENSION", @"VARCHAR(5) NOT NULL"));
            database_columns.Add(new Tuple<int, string, string>(5, @"PATH", @"VARCHAR(512) CHARACTER SET UTF8 NOT NULL"));
        ...
        void PrepareConnectionString()
        {
            ...
            database_connection_string_builder.Password = "92022013773SYSBDA"; // Haslo nadane podczas instalacji Firebird'a użytkownikowi SYSDBA, uzupełnić w zależności u kogo jest jakie
